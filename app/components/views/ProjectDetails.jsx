  ...
  render() {
    ...
    return (
      <article className="content">
        ...
        <div className="columns has-text-centered">
          <div className="column">
            <p className="heading">Discounted Hours</p>
            <p className="title">{ this.props.getDiscountedHours() }</p>
          </div>
          
          <div className="column">
            <p className="heading">Total Hours</p>
        ...
        <div className="columns has-text-centered">
          <div className="column">
            <p className="heading">Discounted Cost</p>
            <p className="title" style={ discountedValue ? isDanger : null }>
          ...
          <div className="column">
            ...
            <p className="title" style={ isSafe } >{ this.props.valueUnit } { this.props.getTotalValue() }</p>
          </div>
        </div>
        
        <div className="is-fullwidth has-text-right">
          <hr />
          <button className="button is-primary is-outlined" onClick={ this.props.onExportClick }>
            Export
          </button>
        </div>
      </article> 
